...
export function pronuCreate() {
    ...
    (async () => {
        ...
        if (wordELement !== null && defELement !== null && langElement !== null && pronunElement !== null && imgElement !== null)  {
            ...
            const data = { 'word' : wordName, 'img':img ,'languages':languages, 'definition':definition, 'pronunciation':pronunciation }; // -- (1)
