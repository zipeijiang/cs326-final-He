export class Database {
    ...
    private uri = "postgres://vvmqhshstldttk:398a265d41d76ef261f27d938fe6878dc2e8d0b257d6116d9bafd6d886c7863d@ec2-54-197-48-79.compute-1.amazonaws.com:5432/d1salrb4eit00v";
    private db: any;
    private dbName : string = "vvmqhshstldttk";
    ...
    constructor(dbName : string) {
        ...
        (async () => {
            try {
            await this.db.none('CREATE TABLE wordTable (word VARCHAR(50) PRIMARY KEY, img VARCHAR(200), languages VARCHAR(200))');
            // add new tables here
    ...
    public async create(word:string, img:string,lang:string,definition:string) : Promise<void>{
        ...
        try {
            await this.db.none('INSERT INTO wordTable(key, value, languages) values ($1, $2, $3)', [word, img, lang]);
        } catch (err) {
            try {
